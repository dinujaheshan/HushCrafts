...
export class NotificationService {
   ...
   */
  private static async logEmail(recipient: string, template: string, subject: string, status: 'sent' | 'failed', errorMessage: string | null = null) {
    try {
   ...
   */
  private static getBrandedEmailWrapper(title: string, bodyContent: string): string {
    return `
   ...
   */
  static async sendNewProductAlert(product: { name: string; description: string; price: number; image: string; id: string }) {
    try {
  ...
  private static async sendProductLaunchEmail(bccEmails: string[], product: { name: string; description: string; price: number; image: string; id: string }) {
   ...
   */
  static async sendOrderConfirmation(email: string, orderId: string, customerName: string, items: any[], total: number, paymentMethod: string = 'online') {
   ...
   */
  static async sendOrderShipped(email: string, orderId: string, customerName: string, carrier: string, trackingNumber: string) {
   ...
   */
  static async sendOrderInvoiceEmail(email: string, orderId: string, customerName: string, order: any) {
   ...
   */
  static async sendStatusUpdateEmail(email: string, orderId: string, customerName: string, status: string, note: string | null = null) {
   ...
   */
  static async sendLowStockAlert(adminEmail: string, sku: string, quantity: number, threshold: number) {
